...
class DB_install extends Base_model
{
	...
	public function create_tables($value='')
		{
			...
			$this->CreateTable_salary_master_history();
	...
	public function drop_tables($value='')
		{
			...
			$this->DropTable_salary_master_history();
	...
	public function CreateTable_employee_error()
	{
		$fields = array(
            		'srno' 			=> array(
					                    'type' => 'INT',                 
		            ...
		            'current_emp_id'    => array(
					                    'type' =>'VARCHAR',
					                    'constraint' => '50'                  
							            ),
		            'current_entity_name'=> array(
					                    'type' =>'TEXT'	                                      
							            ),
		            'flag'=> array(
					                    'type' =>'INT'	                                      
		...
		$this->dbforge->add_key('srno', TRUE);
	    $this->dbforge->add_field($fields);
	    return $this->dbforge->create_table('employee_error',TRUE);
	}

	public function DropTable_employee_error()
	{
		$this->dbforge->drop_table('employee_error');
	}
	...
	public function CreateTable_salary_master_history()
	{
		$fields = array(
	'srno' 			=> array(
	                    'type' => 'INT',                 
    ...
    'total_deduction'			=> array(
		...
		$this->dbforge->add_key('srno', TRUE);
	    $this->dbforge->add_field($fields);
	    return $this->dbforge->create_table('salary_master_history',TRUE);
	}

	public function DropTable_salary_master_history()
	{
		$this->dbforge->drop_table('salary_master_history');
	}

	public function CreateTable_temp_salary_master()
	{
		$fields = array(
	'srno' 			=> array(
	                    'type' => 'INT',                 
    ...
    'total_deduction'			=> array(
		...
		$this->dbforge->add_key('srno', TRUE);
	    $this->dbforge->add_field($fields);
	    return $this->dbforge->create_table('temp_salary_master',TRUE);
	}

	public function DropTable_temp_salary_master()
	{
		$this->dbforge->drop_table('temp_salary_master');
	}

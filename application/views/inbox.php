...
<div class="row">
	...
	<div class="message-list" id="message-list">
		<!-- <div class="message-item message-unread">
			...
			<span class="summary">
				<span class="text">
					Click to open thisfffffffffff message
				</span>
			</span>
		</div> -->
		<?php 
		if (!empty($inbox)) {
			$total_msg=sizeof($inbox);
		...
		<div class="message-item message-unread">
			...
			<span class="textd">
				<a href="#modal-wizard-company" data-toggle="modal" class="blue sub" title="subject title" data-msg="<?php echo $key->message;?>" data-subject="<?php echo $key->subject;?>" data-cust_name="<?php echo $key->entity_name;?>" data-sender="<?php echo $key->sender_id;?>" data-attachments="<?php echo $key->attachment;?>">
	...
	<div class="pull-left"> <?php echo $total_msg;?> messages total </div>
			...
			<li>
				<a href="#">
					<i class="ace-icon fa fa-angle-right bigger-150"></i>
								...
								<?php
		$attributes = array('name' => 'frmRegistration','class'=>'hide form-horizontal message-form col-xs-12', 'id' => 'id-message-form');
		 echo form_open_multipart(''.$user_type.'/send-mail',$attributes );?>	
								<!-- <form id="id-message-form" class="hide form-horizontal message-form col-xs-12"> -->
									<div>
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-recipient">Recipient Name:</label>

											<div class="col-sm-9">
												<span class="input-icon">
													<input type="text" name="cust_name" id="form-field-recipient" data-value="alex@doe.com"  placeholder="Recipient(s)" />

													<input type="text" name="custid" id="form-field-recipient" data-value="alex@doe.com"  placeholder="Recipient(s)" />
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="form-field-recipient">Recipient Email:</label>

											<div class="col-sm-9">
												<span class="input-icon">
													<input type="email" name="email" id="form-field-recipient" data-value="alex@doe.com"  placeholder="Recipient(s)" />
													<i class="ace-icon fa fa-user"></i>
												</span>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-6 col-xs-12">
												<div class="input-icon block col-xs-12 no-padding">
													<input maxlength="900" type="text" class="col-xs-12" name="subject" id="form-field-subject" placeholder="Subject" />
										...
										<div class="align-right">
											<input type="submit" name="submit" id="id-add-attachment" class="btn btn-sm btn-danger" value="Send Mail"/>
...
<script type="text/javascript">
			...
			//message 
				$('.sub').on('click', function(e) {
					...
					// var sender=$(this).data('sender');
					var attach=$(this).data('attachments');
					$('.sender').html(sender);
					$('.message-body').html(msg);
					$('.attached-name').html(attach_name);

					$('#down').attr('href',attach);
				...
				*/
				...
				function initialize_form() {
					...
					// alert($('.message-form .wysiwyg-editor').html());
			$(".message-form .wysiwyg-editor").focusout(function(){
			  	$('#msg').val($('.message-form .wysiwyg-editor').html());			    
			  });
					...
					<div class="message-content" id="id-message-content">
									<div class="message-header clearfix">
										<div class="pull-left">
											...
											&nbsp;
											<img class="middle" alt="John's Avatar" src="<?php echo base_url();?>assets/dashboard/images/avatars/avatar.png" width="32" />
											&nbsp;
									...
									<div class="message-attachment clearfix">
										...
										<ul class="attachment-list pull-left list-unstyled">
											<li>
												...
												<span class="action-buttons">
													<a class="attach" id='down' download>
										...
										<div class="attachment-images pull-right">
											...
											<div>
												<img width="36" alt="image 4" src="<?php echo base_url();?>assets/dashboard//images/gallery/thumb-4.jpg" />
												<img width="36" alt="image 3" src="<?php echo base_url();?>assets/dashboard//images/gallery/thumb-3.jpg" />
												<img width="36" alt="image 2" src="<?php echo base_url();?>assets/dashboard/images/gallery/thumb-2.jpg" />
												<img width="36" alt="image 1" src="<?php echo base_url();?>assets/dashboard/images/gallery/thumb-1.jpg" />
											</div>
										</div>
									</div>
								</div><!-- /.message-content -->
